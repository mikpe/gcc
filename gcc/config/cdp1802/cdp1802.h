...
#define CDP1802_R2	2		/* fixed, interrupt and SCRT SP */
#define CDP1802_R3	3		/* fixed, SCRT PC */
#define CDP1802_R4	4		/* fixed, SCRT call routine */
#define CDP1802_R5	5		/* fixed, SCRT return routine */
#define CDP1802_R6	6		/* fixed, SCRT link register */
...
#define CDP1802_R11	11		/* caller-save, static chain, indirect call target */
...
/* CDP1802 SCRT (Standard Call and Return Technique) register aliases.  */
#define CDP1802_SP	CDP1802_R2	/* SCRT and hardware interrupt Stack Pointer */
#define CDP1802_PC	CDP1802_R3	/* SCRT Program Counter */
#define CDP1802_CALL	CDP1802_R4	/* SCRT routine to make recursive calls */
#define CDP1802_RETN	CDP1802_R5	/* SCRT routine to return from recursive calls */
#define CDP1802_LINK	CDP1802_R6	/* SCRT Link (Return Address) Register */
...
#define CDP1802_SC	CDP1802_R11	/* static chain */
...
#define REG_ALLOC_ORDER { 10, 9, 8, 7, 11, 12, 13, 14, 15, 17, 0, 1, 2, 3, 4, 5, 6, 16, 18 }
...
#define FIRST_PARM_OFFSET(FUNDECL) 2

#define RETURN_ADDR_RTX(COUNT, FRAMEADDR) \
  ((COUNT) == 0 ? INCOMING_RETURN_ADDR_RTX : NULL_RTX)

#define INCOMING_RETURN_ADDR_RTX gen_rtx_REG (Pmode, CDP1802_LINK)

#define DWARF_FRAME_RETURN_COLUMN DWARF_FRAME_REGNUM (CDP1802_LINK)

#define INCOMING_FRAME_SP_OFFSET 2

/* Exception Handling Support.  */

/* Use the caller-save r7..r10 for eh return and r11 for eh stack adj.  */
...
#define HAVE_POST_INCREMENT 1	/* lda, ldxa */
...
#define USE_STORE_POST_INCREMENT(MODE) 0	/* Post-increment is only available for loads.  */
