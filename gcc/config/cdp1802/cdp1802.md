...
(define_insn "pushqi1"
  [(set (mem:QI (post_dec:QI (reg:HI SP_REG)))
...
(define_insn "popqi1"
  [(set (match_operand:QI 0 "register_operand" "=r")
	(mem:QI (post_inc:QI (reg:HI SP_REG))))
   ;(clobber (reg:QI D_REG))
   ;(clobber (reg:?? X_REG))
  ]
  ""
...
;;
(define_expand "movqi"
  [(set (match_operand:QI 0 "cdp1802_nonimmediate_nonstack_operand" "")
	(match_operand:QI 1 "general_operand" ""))
  ])

(define_insn "movqi_internal"
  [(set (match_operand:QI 0 "cdp1802_nonimmediate_nonstack_operand" "=r,m,m,r,r")
	(match_operand:QI 1 "general_operand" "r,r,i,m,i"))
   ;(clobber (reg:QI D_REG))
  ]
  ""
  "@
...
(define_expand "movhi"
  [(set (match_operand:HI 0 "cdp1802_nonimmediate_nonstack_operand" "")
	(match_operand:HI 1 "general_operand" ""))
  ])

(define_insn "movhi_internal"
  [(set (match_operand:HI 0 "cdp1802_nonimmediate_nonstack_operand" "=r,m,m,r,r")
	(match_operand:HI 1 "general_operand" "r,r,i,m,i"))
   ;(clobber (reg:QI D_REG))
  ]
  ""
  "@
