...
#ifndef _N_CHAR_
#define _N_CHAR_
typedef unsigned _KCCtype_char8 n_char;
#endif
#endif
...
typedef	unsigned size_t;	/* Type big enough to hold any "sizeof" val */
#endif
#ifndef _SSIZE_T_DEFINED	/* AVOID clash with ANSI <stddef.h> */
#define _SSIZE_T_DEFINED
typedef	long	ssize_t;	/* Signed scalar */
#endif
...
/* Changed these to only use 32 bits in the fdset..so as to
 * get rid of divides and modulos..
 * 
 * -sumit, dec.11.2002
 */
