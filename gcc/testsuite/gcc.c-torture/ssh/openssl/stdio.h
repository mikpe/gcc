...
/* Direct I/O */
size_t fread __P((char*, size_t, size_t, FILE*));	/* ptr, size, nmemb, stream */
size_t fwrite __P((const char*, size_t, size_t, FILE*)); /* ptr, size, nmemb, strm */
...
FILE *funopen __P((char *,
		   int (*)(char *, char *, size_t),
		   int (*)(char *, const char *, size_t),
		   fpos_t (*)(char *, fpos_t, int),
		   int (*)(char *)));
...
struct _siostream {
    ...
    int siofd;			/* FD for stream (cookie from funopen) */
    ...
    char *cookie;		/* cookie from funopen() call */
    int (*readfn)(char *, char *, size_t); /* read function */
    int (*writefn)(char *, const char *, size_t); /* write function */
    fpos_t (*seekfn)(char *, fpos_t, int); /* seek function */
    int (*closefn)(char *);	/* close function */
...
#define _SIOF_FUN	010000000	/* Stream created by funopen() */
