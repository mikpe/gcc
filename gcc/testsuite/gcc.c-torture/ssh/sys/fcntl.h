...
#define O_TEXT		(0)		/* Used by setmode() call only */
...
#define O_T20_ERRORS	(1<<26)		/* Return TOPS20 error codes */
...
#define F_SETBYTESIZE	10	/* Set byte-size for open file */
#endif
...
#define FDF_SOCKET	010000000 /* T20: Socket, not file */
