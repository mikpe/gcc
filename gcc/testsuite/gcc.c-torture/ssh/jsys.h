...
/* no JSYS' 762 */
#define ROUTE	_DEFJS("ROUTE%", 0)
#define XRTOP	_DEFJS("XRTOP%", 0)
...
#if 0
/* These potentially conflict with Internet Protocol definitions
 * from netinet/in.h (IP_TTL actually conflicts).
 */
...
#define _GTHSZ	monsym(".GTHSZ")	/*    GTHST    */
#define _GTHIX	monsym(".GTHIX")
#define _GTHNS	monsym(".GTHNS")
#define _GTHSN	monsym(".GTHSN")
#define _GTHHN	monsym(".GTHHN")
#define _GTHHI	monsym(".GTHHI")
#define _GTHLN	monsym(".GTHLN")
#define _GTHNT	monsym(".GTHNT")
#define _GTHLA	monsym(".GTHLA")
#define _GTHPN	monsym(".GTHPN")
#define _GTHMX	monsym(".GTHMX")
#define _GTHAA	monsym(".GTHAA")
#define _GTHVN	monsym(".GTHVN")
#define _GTHOS	monsym(".GTHOS")
#define _GTHDN	monsym(".GTHDN")
#define _GTHNC	monsym(".GTHNC")
...
#define _IPRES	monsym(".IPRES")	/* IPOPR% */
#define _IPSNT	monsym(".IPSNT")
#define PR_IP	monsym("PR$IP")
...
#define _RTADD	monsym(".RTADD")       /* ROUTE% */
#define _RTDEL	monsym(".RTDEL")
#define _RTCNT	monsym(".RTCNT")
#define _RTRTN	monsym(".RTRTN")
