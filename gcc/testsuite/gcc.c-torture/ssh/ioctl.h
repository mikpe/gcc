...
/* kernel route table support */
#define SIOCADDRT	31	/* add route */
#define SIOCDELRT	32	/* delete route */

/* Network interface status */
#define SIOCGIFADDR	33	/* Get interface address */
#define SIOCGIFDSTADDR	34	/* Get point-to-point address */
#define SIOCGIFFLAGS	35	/* Get interface flags */
#define SIOCGIFNETMASK	36	/* Get network address mask */
#define SIOCGIFBRDADDR	37	/* Get broadcast address */
#define SIOCGIFMTU	38	/* Get maximum transmission unit size */
#define SIOCGIFHWADDR	39	/* Get MAC address */
#define SIOCGIFNAME	40	/* Get interface name */
#define SIOCGIFSLTPRC	41	/* Get slot and processor number */
#define SIOCSIFFLAGS	42	/* Set interface flags */

/* additional kernel route table support */
#define SIOCGRTSIZE	43	/* Get size of kernel routing table */
#define SIOCGRTTABLE	44	/* Get kernel routing table */

/*
